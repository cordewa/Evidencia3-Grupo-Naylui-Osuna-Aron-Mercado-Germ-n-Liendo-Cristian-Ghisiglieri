...
class Conectar():
    ...
    def Insertar_Productos(self,idproducto,idcategoria,nombre,stock,precio,unid_medida,):
    ...
    def Insertar_Insumos(self,idinsumo,nombre,stock,precio,):
        ...
        try:
            cursor = conexion.Conectar.cursor()
            sentenciaSQL = "INSERT INTO insumos values(null,%s,%s,%s)"
    ...
    def Insertar_Recetas(self,idreceta,nombre,idproducto,cant_producto,):
        ...
        try:
            cursor = conexion.Conectar.cursor()
            sentenciaSQL = "INSERT INTO recetas values(null,%s,null,%s)"
    ...
    def Modificar_Productos(self,idproducto,idcategoria,nombre,stock,precio,unid_medida,):
        conection = conexion.Conectar()
        try:
            cursor = conexion.Conectar.cursor()
            sentenciaSQL = "UPDATE Productos SET nombre = '' WHERE IdProducto = "
            data = (idproducto, idcategoria, nombre, stock, precio, unid_medida)
            cursor.execute(sentenciaSQL,data)
            cursor.conexion.commit()
            cursor.conexion.close()
    ...
    def Eliminar_Productos(self,idproducto,idcategoria,nombre,stock,precio,unid_medida,):
        conection = conexion.Conectar()
        try:
            cursor = conexion.Conectar.cursor()
            sentenciaSQL = "DELETE FROM Productos WHERE IdProducto = "
            data = (idproducto, idcategoria, nombre, stock, precio, unid_medida)
            cursor.execute(sentenciaSQL,data)
            cursor.conexion.commit()
            cursor.conexion.close()
